...
const DealsClosedCard = () => {
  return (
    <Widget>
      <div className="kd-dealclose-header">
        <div>
          <h2 className="h4 kd-mb-2">927 Deals Closed</h2>
          <p className="kd-text-grey">This year</p>
        </div>
        <div className="kd-dealclose-header-right">
          <p className="kd-mb-2">
            <Badge className="kd-mb-0" status="warning" />
            Queries
          </p>
          <p className="kd-ml-2 kd-mb-2">
            <Badge className="kd-mb-0" status="processing" />
            Closed Deals
          </p>
        </div>
      </div>
