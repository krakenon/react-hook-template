  ...
  const getNavStyleSubMenuClass = (navStyle) => {
    switch (navStyle) {
      case NAV_STYLE_DEFAULT_HORIZONTAL:
        return 'kd-menu-horizontal kd-submenu-popup-curve';
      case NAV_STYLE_INSIDE_HEADER_HORIZONTAL:
        return 'kd-menu-horizontal kd-submenu-popup-curve kd-inside-submenu-popup-curve';
      case NAV_STYLE_BELOW_HEADER:
        return 'kd-menu-horizontal kd-submenu-popup-curve kd-below-submenu-popup-curve';
      case NAV_STYLE_ABOVE_HEADER:
        return 'kd-menu-horizontal kd-submenu-popup-curve kd-above-submenu-popup-curve';
      default:
        return 'kd-menu-horizontal';
    }
  };
